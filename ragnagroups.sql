...
CREATE TABLE IF NOT EXISTS `topico`(
	...
	topAutor		VARCHAR(50) NOT NULL, /*nome do autor do topico*/
...
CREATE TABLE IF NOT EXISTS `posts`( /*cada post deve estar atrelado à um tópico.*/
	...
	postConteudo	VARCHAR NOT NULL, /*ess campo recebe todo conteudo do post, devo converter com php todos cararetes para htmml special chars...*/
