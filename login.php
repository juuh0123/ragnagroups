<?php include 'funcoes.php'; ?> <!--NESSA CLASSE EU PRECISO VALIDAR SE A SESSAO JÁ ESTA ABERTA SE SIM MANDO PARA O FORUM SENAO PARA LOGIN AS DUAS VAO SE TELAS DENTRO DO FORUM.PHP-->
<!DOCTYPE html>
<html lang="pt-BR">
	<head>
